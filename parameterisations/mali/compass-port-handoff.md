...
| MALI with the Burgard melt module | `.../MALI-melt-calibration/MALI-Dev` | `develop` | **merged** (PR #191, `013c387242`); feature branch remains on `xylar/E3SM` only |
...
feature-branch worktree has been removed; the branch survives only on `xylar/E3SM`.
